    ...
    <div>
      ...
      <div>
        <div className="w-full relative bg-img-height items-center justify-center xl:flex hidden">
          ...
          />
          <button className="text-5xl text-white rounded-lg bg-color-orange px-14 py-2 relative hover:opacity-90">
            MENU CARD
          </button>
        </div>
      </div>
      <div className="w-full relative flex items-center justify-center xl:hidden md:h-64 h-32 xl:pt-16 pt-0">
        <img
          ...
          className="w-full h-full absolute"
        />
        <button className="text-base text-white rounded-lg bg-color-orange px-6 py-2 relative hover:opacity-90">
          MENU CARD
        </button>
      </div>
      {/* Hero */}
