        ...
        <nav className="mx-auto container relative z-10">
          <div className="lg:flex hidden items-center justify-between py-12 xl:px-0 px-4">
            <a href="/">
              <img
                loading="lazy"
                src="https://cdn.tuk.dev/assets/templates/foodies/foodies.png"
                className="w-44"
                alt="logo"
              />
            </a>
          ...
          <div className="flex lg:flex-row flex-col-reverse items-center justify-between lg:mt-24">
            <div className="lg:w-1/2">
              <h1 className="text-6xl lg:block hidden leading-115 border-l-8 border-color-orange pl-12">
                Craving for
                <br />
                <span className="2xl:text-8xl text-7xl font-bold">
                  {" "}
                  Healthy Food?{" "}
                </span>
              </h1>
              ...
              <h1 className="lg:text-2xl text-lg text-color-gray lg:leading-8 leading-6 mt-6 border-l-8 border-color-orange lg:pl-12 pl-2 py-2">
                ...
                yummy and healthy food within minutes.
              </h1>
              <div className="flex items-center justify-center mt-12">
                <a href="/menu">
                  {" "}
                  <button className="xl:py-5 py-2 xl:px-16 px-6 bg-color-orange 2xl:text-3xl lg:text-xl text-base font-semibold leading-loose text-white focus:outline-none hover:opacity-90 border-2 border-color-orange b-r-10 mr-10">
                    View Menu
                  </button>
                </a>
